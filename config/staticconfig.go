...
var StaticAppConfig = AllConfig{
	TapoCredentials: TapoCredentials, // TODO: read from env, file or command line
	Devices: []types.DeviceConfig{ // TODO: read from env, file or command line
		// Lights
		{
			Name:  "Pendant Light",
			Ip:    "192.168.1.50",
